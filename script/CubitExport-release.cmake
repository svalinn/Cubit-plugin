...
set_target_properties(trelis_lm PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/MacOS/libtrelis_lm.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libtrelis_lm.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS trelis_lm )
list(APPEND _IMPORT_CHECK_FILES_FOR_trelis_lm "${_IMPORT_PREFIX}/MacOS/libtrelis_lm.dylib" )
...
set_target_properties(clarofw PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/MacOS/libclarofw.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libclarofw.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS clarofw )
list(APPEND _IMPORT_CHECK_FILES_FOR_clarofw "${_IMPORT_PREFIX}/MacOS/libclarofw.dylib" )
...
set_target_properties(navigation PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/MacOS/libnavigation.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libnavigation.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS navigation )
list(APPEND _IMPORT_CHECK_FILES_FOR_navigation "${_IMPORT_PREFIX}/MacOS/libnavigation.dylib" )
...
set_target_properties(clarogui PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/MacOS/libclarogui.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libclarogui.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS clarogui )
list(APPEND _IMPORT_CHECK_FILES_FOR_clarogui "${_IMPORT_PREFIX}/MacOS/libclarogui.dylib" )
...
set_target_properties(gtcAttrib PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/MacOS/libgtcAttrib.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libgtcAttrib.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gtcAttrib )
list(APPEND _IMPORT_CHECK_FILES_FOR_gtcAttrib "${_IMPORT_PREFIX}/MacOS/libgtcAttrib.dylib" )
...
set_target_properties(cubit_sizing_source PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/MacOS/libcubit_sizing_source.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libcubit_sizing_source.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS cubit_sizing_source )
list(APPEND _IMPORT_CHECK_FILES_FOR_cubit_sizing_source "${_IMPORT_PREFIX}/MacOS/libcubit_sizing_source.dylib" )
...
set_target_properties(cubit_mdb PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/MacOS/libcubit_mdb.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS cubit_mdb )
list(APPEND _IMPORT_CHECK_FILES_FOR_cubit_mdb "${_IMPORT_PREFIX}/MacOS/libcubit_mdb.a" )
...
set_target_properties(cubit_sim PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/MacOS/libcubit_sim.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS cubit_sim )
list(APPEND _IMPORT_CHECK_FILES_FOR_cubit_sim "${_IMPORT_PREFIX}/MacOS/libcubit_sim.a" )
...
set_target_properties(material_commands PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/MacOS/plugins/libmaterial_commands.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )

list(APPEND _IMPORT_CHECK_TARGETS material_commands )
list(APPEND _IMPORT_CHECK_FILES_FOR_material_commands "${_IMPORT_PREFIX}/MacOS/plugins/libmaterial_commands.so" )
...
set_target_properties(cubit_parsing_core PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/MacOS/libcubit_parsing_core.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS cubit_parsing_core )
list(APPEND _IMPORT_CHECK_FILES_FOR_cubit_parsing_core "${_IMPORT_PREFIX}/MacOS/libcubit_parsing_core.a" )
...
set_target_properties(cubiti PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/MacOS/libcubiti19.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libcubiti19.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS cubiti )
list(APPEND _IMPORT_CHECK_FILES_FOR_cubiti "${_IMPORT_PREFIX}/MacOS/libcubiti19.dylib" )
...
set_target_properties(cubit_python PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/MacOS/libcubit_python.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libcubit_python.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS cubit_python )
list(APPEND _IMPORT_CHECK_FILES_FOR_cubit_python "${_IMPORT_PREFIX}/MacOS/libcubit_python.dylib" )
...
set_target_properties(cubit_python3 PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/MacOS/python3/libcubit_python3.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )

list(APPEND _IMPORT_CHECK_TARGETS cubit_python3 )
list(APPEND _IMPORT_CHECK_FILES_FOR_cubit_python3 "${_IMPORT_PREFIX}/MacOS/python3/libcubit_python3.so" )
...
set_target_properties(cubit_python2 PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/MacOS/python2/libcubit_python2.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )

list(APPEND _IMPORT_CHECK_TARGETS cubit_python2 )
list(APPEND _IMPORT_CHECK_FILES_FOR_cubit_python2 "${_IMPORT_PREFIX}/MacOS/python2/libcubit_python2.so" )
...
set_target_properties(treemodel PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/MacOS/libtreemodel.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libtreemodel.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS treemodel )
list(APPEND _IMPORT_CHECK_FILES_FOR_treemodel "${_IMPORT_PREFIX}/MacOS/libtreemodel.dylib" )
...
set_target_properties(pickwidget PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "Qt5::Widgets"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/MacOS/libpickwidget.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libpickwidget.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS pickwidget )
list(APPEND _IMPORT_CHECK_FILES_FOR_pickwidget "${_IMPORT_PREFIX}/MacOS/libpickwidget.dylib" )
